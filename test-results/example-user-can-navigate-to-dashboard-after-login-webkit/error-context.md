...
- generic [ref=e3]:
  - generic [ref=e4]:
    - link "Laravel" [ref=e6]:
      ...
      - text: Laravel
    - blockquote [ref=e10]:
      - paragraph [ref=e11]: “When there is no desire, all things are at peace.”
      - contentinfo [ref=e12]: Laozi
  - generic [ref=e14]:
    - generic [ref=e15]:
      ...
      - generic [ref=e23]:
        - generic [ref=e24]:
          ...
          - link "Forgot password?" [ref=e26]:
            - /url: /forgot-password
        - textbox "Password" [ref=e27]: password
      - generic [ref=e28]:
        - checkbox "Remember me" [ref=e29]
        - checkbox
        - generic [ref=e30]: Remember me
      - button "Loading Log in" [disabled]:
        - status "Loading"
        - text: Log in
```
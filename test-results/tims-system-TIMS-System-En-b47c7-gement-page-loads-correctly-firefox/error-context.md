...
- generic [ref=e3]:
  - generic [ref=e4]:
    - link "Laravel" [ref=e6] [cursor=pointer]:
      ...
      - text: Laravel
    - blockquote [ref=e10]:
      - paragraph [ref=e11]: “Act only according to that maxim whereby you can, at the same time, will that it should become a universal law.”
      - contentinfo [ref=e12]: Immanuel Kant
  - generic [ref=e14]:
    - generic [ref=e15]:

...
- generic [ref=e3]:
  - generic [ref=e4]:
    - link "Laravel" [ref=e6] [cursor=pointer]:
      ...
      - text: Laravel
    - blockquote [ref=e10]:
      - paragraph [ref=e11]: “Simplicity is the consequence of refined emotions.”
      - contentinfo [ref=e12]: Jean D'Alembert
  - generic [ref=e14]:
    - generic [ref=e15]:
    ...
    - generic [ref=e19]:
      - generic [ref=e20]:
        ...
        - textbox "Email address" [ref=e22]:
          ...
          - text: admin@test.com
        - paragraph [ref=e23]: These credentials do not match our records.
      - generic [ref=e24]:
        - generic [ref=e25]:

...
export default function WoredasCreate({ zones }: WoredasCreateProps) {
  const { data, setData, post, processing, errors, reset } = useForm<WoredaFormData>({
    name: '',
    status: 'active',
    code: '',
    zone_id: '',
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <CardDescription className="text-sm text-slate-600 dark:text-slate-400">
                    Document administrative districts with spatial context and infrastructure readiness for deployment planning.
                  </CardDescription>
                </div>
              </div>
              ...
              <section className="space-y-4 rounded-xl border border-slate-200/60 bg-white/75 p-5 shadow-sm dark:border-slate-800/70 dark:bg-slate-900/35">
                <div className="flex items-center gap-2.5 text-sm">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-xs text-muted-foreground">Capture core governance and classification details for the woreda.</p>
                  </div>
                </div>
              ...
              <section className="space-y-4 rounded-xl border border-slate-200/60 bg-white/75 p-5 shadow-sm dark:border-slate-800/70 dark:bg-slate-900/35">
                <div className="flex items-center gap-2.5 text-sm">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-xs text-muted-foreground">Provide geographic metrics to support coverage analytics.</p>
                  </div>
                </div>

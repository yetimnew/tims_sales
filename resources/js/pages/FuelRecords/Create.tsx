...
import { ArrowLeft, Fuel, Truck, User, MapPin, Calendar, DollarSign, FileText, CheckCircle, Save } from 'lucide-react';
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Create Fuel Record</h1>
                                    <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">Add a new fuel consumption record</p>
                                </div>
                            </div>
                        </div>
                ...
                <Card className="shadow-lg border-0 bg-gradient-to-br from-background to-muted/20">
                    <CardHeader className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 border-b">
                        ...
                        <CardDescription className="text-base">
                            Record fuel consumption details for your fleet vehicles
                        </CardDescription>
                    </CardHeader>
                            ...
                            <div className="space-y-4">
                                <div className="rounded-lg bg-slate-50 dark:bg-slate-800/50 p-4 border border-slate-200 dark:border-slate-700">
                                    ...
                                    <Select value={data.driver_truck_id} onValueChange={(value) => handleFieldChange('driver_truck_id', value)}>
                                        <SelectTrigger className={`transition-colors focus:ring-2 focus:ring-blue-500 ${allErrors.driver_truck_id ? 'border-red-500 focus:ring-red-500' : ''}`}>
                                ...
                                <div className="space-y-4">
                                    <div className="rounded-lg bg-slate-50 dark:bg-slate-800/50 p-4 border border-slate-200 dark:border-slate-700">
                                        ...
                                        <Input
                                            ...
                                            className={`transition-colors focus:ring-2 focus:ring-blue-500 ${allErrors.fuel_date ? 'border-red-500 focus:ring-red-500' : ''}`}
                                        />
                                        {allErrors.fuel_date && (
                                            <div className="flex items-center gap-2 mt-2 text-red-600 dark:text-red-400">
                                                <CheckCircle className="h-4 w-4" />
                                ...
                                <div className="space-y-4">
                                    <div className="rounded-lg bg-slate-50 dark:bg-slate-800/50 p-4 border border-slate-200 dark:border-slate-700">
                                        ...
                                        <Input
                                            ...
                                            className={`transition-colors focus:ring-2 focus:ring-blue-500 ${allErrors.fuel_station ? 'border-red-500 focus:ring-red-500' : ''}`}
                                        />
                                ...
                                <div className="space-y-4">
                                    <div className="rounded-lg bg-slate-50 dark:bg-slate-800/50 p-4 border border-slate-200 dark:border-slate-700">
                                        ...
                                        <Select value={data.fuel_type} onValueChange={(value) => handleFieldChange('fuel_type', value)}>
                                            <SelectTrigger className={`transition-colors focus:ring-2 focus:ring-blue-500 ${allErrors.fuel_type ? 'border-red-500 focus:ring-red-500' : ''}`}>
                                ...
                                <div className="space-y-4">
                                    <div className="rounded-lg bg-slate-50 dark:bg-slate-800/50 p-4 border border-slate-200 dark:border-slate-700">
                                        ...
                                        <Input
                                            ...
                                            className={`transition-colors focus:ring-2 focus:ring-blue-500 ${allErrors.fuel_quantity_liters ? 'border-red-500 focus:ring-red-500' : ''}`}
                                        />
                                ...
                                <div className="space-y-4">
                                    <div className="rounded-lg bg-slate-50 dark:bg-slate-800/50 p-4 border border-slate-200 dark:border-slate-700">
                                        ...
                                        <Input
                                            ...
                                            className={`transition-colors focus:ring-2 focus:ring-blue-500 ${allErrors.fuel_price_per_liter ? 'border-red-500 focus:ring-red-500' : ''}`}
                                        />
                                ...
                                <div className="space-y-4">
                                    <div className="rounded-lg bg-slate-50 dark:bg-slate-800/50 p-4 border border-slate-200 dark:border-slate-700">
                                        ...
                                        <Input
                                            ...
                                            className={`transition-colors focus:ring-2 focus:ring-blue-500 ${allErrors.receipt_number ? 'border-red-500 focus:ring-red-500' : ''}`}
                                        />
                                ...
                                <div className="space-y-4">
                                    <div className="rounded-lg bg-slate-50 dark:bg-slate-800/50 p-4 border border-slate-200 dark:border-slate-700">
                                        ...
                                        <Input
                                            ...
                                            className={`transition-colors focus:ring-2 focus:ring-blue-500 ${allErrors.odometer_reading ? 'border-red-500 focus:ring-red-500' : ''}`}
                                        />
                                ...
                                <div className="space-y-4">
                                    <div className="rounded-lg bg-slate-50 dark:bg-slate-800/50 p-4 border border-slate-200 dark:border-slate-700">
                                        ...
                                        <Textarea
                                            ...
                                            rows={3}
                                            className={`transition-colors focus:ring-2 focus:ring-blue-500 ${allErrors.notes ? 'border-red-500 focus:ring-red-500' : ''}`}
                                        />
                                        {allErrors.notes && (
                                            <div className="flex items-center gap-2 mt-2 text-red-600 dark:text-red-400">
                                                <CheckCircle className="h-4 w-4" />
                            ...
                            <div className="flex items-center justify-between pt-6 border-t border-slate-200 dark:border-slate-700">
                                ...
                                <div className="flex gap-3">
                                    ...
                                    >
                                        ...
                                        {processing ? 'Creating...' : 'Create Fuel Record'}
                                    </Button>
                                </div>
                            </div>
                        </form>

...
export default function PlacesEdit({ place, woredas }: PlacesEditProps) {
  ...
  const { data, setData, put, processing, errors } = useForm<PlaceFormData>({
    ...
    accessibility_score:
      place.accessibility_score !== null && place.accessibility_score !== undefined
        ? String(place.accessibility_score)
        : '',
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <CardDescription className="text-sm text-slate-600 dark:text-slate-400">
                    Ensure location intelligence stays accurate for planning and dispatch workflows.
                  </CardDescription>
                </div>
              </div>
              ...
              {hasErrors && (
                <div className="flex items-start gap-3 rounded-lg border border-destructive/40 bg-destructive/10 p-4 text-destructive">
                  ...
                  <div>
                    ...
                    <p className="text-sm opacity-80">Correct the validation errors before saving the place record.</p>
                  </div>
                </div>
              )}
              ...
              <section className="space-y-4 rounded-xl border border-slate-200/60 bg-white/75 p-5 shadow-sm dark:border-slate-800/70 dark:bg-slate-900/35">
                <div className="flex items-center gap-2.5 text-sm">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-xs text-muted-foreground">Maintain the core identity shown across operations and reporting.</p>
                  </div>
                </div>
              ...
              <section className="space-y-4 rounded-xl border border-slate-200/60 bg-white/75 p-5 shadow-sm dark:border-slate-800/70 dark:bg-slate-900/35">
                <div className="flex items-center gap-2.5 text-sm">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-xs text-muted-foreground">Keep coordinates and scale precise for routing accuracy.</p>
                  </div>
                </div>
              ...
              <section className="space-y-4 rounded-xl border border-slate-200/60 bg-white/75 p-5 shadow-sm dark:border-slate-800/70 dark:bg-slate-900/35">
                <div className="flex items-center gap-2.5 text-sm">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-xs text-muted-foreground">Document infrastructure readiness and road intelligence.</p>
                  </div>
                </div>

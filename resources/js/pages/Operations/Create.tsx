...
export default function OperationsCreate({ customers, regions }: OperationsCreateProps) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-4">
                {/* Header */}
                <div>
                    <h1 className="text-2xl font-bold">Create Operation</h1>
                    <p className="text-muted-foreground">
                        Add a new operation to your system
                    </p>
                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Enter the information for the new operation
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <div className="flex gap-2">
                                <Button type="submit" disabled={processing || Object.keys(frontendErrors).length > 0}>
                                    {processing ? 'Creating...' : 'Create Operation'}
                                </Button>

...
export default function OperationsEdit({
    operation,
    customers,
    regions,
    zones,
    ...
    const initialDestinationScope = allowedScopes.includes((operation.destination_scope ?? '') as OperationFormData['destination_scope'])
        ? (operation.destination_scope as OperationFormData['destination_scope'])
        : 'region';
    ...
    const initialStatus = allowedStatuses.includes(operation.status as OperationFormData['status'])
        ? (operation.status as OperationFormData['status'])
        : 'active';
    const initialCargoServiceType: OperationFormData['cargo_service_type'][] = ['commercial', 'relief'];
    const normalizedCargoServiceType = initialCargoServiceType.includes(operation.cargo_service_type as OperationFormData['cargo_service_type'])
        ? (operation.cargo_service_type as OperationFormData['cargo_service_type'])
        : 'commercial';
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <CardDescription className="text-sm text-slate-600 dark:text-slate-400">
                                        Refresh customer engagement, routing scope, and commercial levers for this active operation.
                                    </CardDescription>
                                </div>
                            </div>
                                ...
                                <div className="flex items-start gap-3 rounded-lg border border-destructive/40 bg-destructive/10 p-4 text-destructive">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm opacity-80">
                                            Correct the validation errors before saving the operation.
                                        </p>
                                    </div>
                                </div>
                            )}
                            ...
                            <section className="space-y-4 rounded-xl border border-slate-200/60 bg-white/75 p-5 shadow-sm dark:border-slate-800/70 dark:bg-slate-900/35">
                                <div className="flex items-center gap-2.5 text-sm">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <p className="text-xs text-muted-foreground">Confirm the core identifiers and customer alignment for this operation.</p>
                                    </div>
                                </div>
                            ...
                            <section className="space-y-4 rounded-xl border border-slate-200/60 bg-white/75 p-5 shadow-sm dark:border-slate-800/70 dark:bg-slate-900/35">
                                <div className="flex items-center gap-2.5 text-sm">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <p className="text-xs text-muted-foreground">Align service type, tonnage, and reach assumptions with updated planning inputs.</p>
                                    </div>
                                </div>
                            ...
                            <section className="space-y-4 rounded-xl border border-slate-200/60 bg-white/75 p-5 shadow-sm dark:border-slate-800/70 dark:bg-slate-900/35">
                                <div className="flex items-center gap-2.5 text-sm">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <p className="text-xs text-muted-foreground">Tune tariff assumptions and note key decisions for the broader ops &amp; finance teams.</p>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                    ...
                                    <div className="space-y-2 md:col-span-2">
                                        ...
                                        <Textarea
                                            ...
                                            placeholder="Capture tariffs, service caveats, and operational reminders"

...
export default function CustomersEdit({ customer }: CustomerEditProps) {
    ...
    <div className="flex h-full flex-1 flex-col gap-6 overflow-auto p-4">
      ...
      <Card className="max-w-2xl">
        <CardHeader className="border-b">
          <h2 className="text-lg font-semibold">Update Customer Details</h2>
        </CardHeader>
...
CustomersEdit.layout = (page: React.ReactNode) => <AppLayout children={page} />

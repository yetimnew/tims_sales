...
export default function PerformanceByDriver({ filters, rows = [], summary, drivers }: PerformanceByDriverProps) {
    ...
    const detailBadgeItems = [
        ...
        {
            key: 'drivers',
            label: appliedDriverCount > 0 ? `${appliedDriverCount} driver${appliedDriverCount > 1 ? 's' : ''}` : 'All drivers',
        },
    ];
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <ReportPageShell>
                ...
                <ReportSectionCard
                    ...
                    description="Key utilisation, revenue, and profitability metrics for the selected drivers."
                ...
                <ReportSectionCard
                    title="Driver performance detail"
                    description="Utilisation, cost, and contribution by driver."

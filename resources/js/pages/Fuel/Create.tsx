...
export default function FuelCreate({ trucks, drivers }: FuelCreateProps) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-4">
                {/* Header */}
                <div>
                    <h1 className="text-2xl font-bold">Record Fuel Consumption</h1>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Enter the fuel consumption information
                        </CardDescription>
                    </CardHeader>
                    <CardContent>

...
export default function ZonesEdit({ zone, regions }: ZonesEditProps) {
    ...
    const { data, setData, put, processing, errors } = useForm<ZoneFormData>({
        ...
        accessibility_score:
            zone.accessibility_score !== null && zone.accessibility_score !== undefined
                ? String(zone.accessibility_score)
                : '',
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <CardDescription className="text-sm text-slate-600 dark:text-slate-400">
                                        Keep sub-regional coverage details aligned with on-the-ground operations.
                                    </CardDescription>
                                </div>
                            </div>
                            ...
                            {hasErrors && (
                                <div className="flex items-start gap-3 rounded-lg border border-destructive/40 bg-destructive/10 p-4 text-destructive">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm opacity-80">Correct validation issues before saving the zone update.</p>
                                    </div>
                                </div>
                            )}
                            ...
                            <section className="space-y-4 rounded-xl border border-slate-200/60 bg-white/75 p-5 shadow-sm dark:border-slate-800/70 dark:bg-slate-900/35">
                                <div className="flex items-center gap-2.5 text-sm">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <p className="text-xs text-muted-foreground">Confirm naming, ownership, and governance context for this zone.</p>
                                    </div>
                                </div>
                            ...
                            <section className="space-y-4 rounded-xl border border-slate-200/60 bg-white/75 p-5 shadow-sm dark:border-slate-800/70 dark:bg-slate-900/35">
                                <div className="flex items-center gap-2.5 text-sm">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <p className="text-xs text-muted-foreground">Keep spatial footprint and demographic scale aligned with latest intel.</p>
                                    </div>
                                </div>
                            ...
                            <section className="space-y-4 rounded-xl border border-slate-200/60 bg-white/75 p-5 shadow-sm dark:border-slate-800/70 dark:bg-slate-900/35">
                                <div className="flex items-center gap-2.5 text-sm">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <p className="text-xs text-muted-foreground">Document logistics readiness, infrastructure notes, and environmental context.</p>
                                    </div>
                                </div>

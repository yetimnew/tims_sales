...
export default function ZonesIndex({ zones, metrics, filters, statusOptions, perPageOptions }: ZonesIndexProps) {
    ...
    const tableRows = zoneData.length > 0
        ...
        <>
            ...
            >
                    ...
                    <div className="relative">
                        ...
                        {isLoading && (
                            <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 bg-background/80 backdrop-blur-sm">
                                <img src="/images/loading-spinner.svg" alt="Loading zones" className="h-12 w-12" />
                ...
                <div className="relative space-y-3 md:hidden">
                    ...
                    {isLoading && (
                        <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 bg-background/80 backdrop-blur-sm">
                            <img src="/images/loading-spinner.svg" alt="Loading zones" className="h-10 w-10" />
                            <span className="text-sm text-muted-foreground">Loading zones...</span>
                        </div>
                    )}
                </div>

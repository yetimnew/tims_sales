...
export default function DriverSafetyCreate({ drivers }: DriverSafetyCreateProps) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Record Safety Incident" />
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <CardTitle className="text-2xl font-semibold text-slate-900 dark:text-slate-100">
                                        Record Driver Safety Incident
                                    </CardTitle>
                                    <CardDescription className="text-sm text-slate-600 dark:text-slate-400">
                                        Document incidents to monitor risk trends and plan targeted coaching.
                                    </CardDescription>
                                </div>
                            </div>
                            ...
                            <section className="space-y-5 rounded-xl border border-slate-200/70 bg-white/80 p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900/40">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">Confirm who was involved and the core details before recording impact.</p>
                                    </div>
                                </div>
                            ...
                            <section className="space-y-5 rounded-xl border border-slate-200/70 bg-white/80 p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900/40">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">Provide the narrative and planned corrective actions for the safety team.</p>
                                    </div>
                                </div>

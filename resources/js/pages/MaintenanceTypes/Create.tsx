...
import { CircleAlert, Settings, Save, HelpCircle, ArrowLeft, CheckCircle, FileText, DollarSign, Calendar } from 'lucide-react';
...
interface MaintenanceTypesCreateProps {
    errors?: Record<string, string>;
}

export default function MaintenanceTypesCreate({ errors }: MaintenanceTypesCreateProps) {
    const { data, setData, post, processing, errors: formErrors, hasErrors } = useForm({
        name: '',
        category: '',
        interval_km: '',
        interval_months: '',
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Create Maintenance Type</h1>
                                    <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">Add a new maintenance type to categorize maintenance activities</p>
                                </div>
                            </div>
                        </div>
                ...
                <Card className="shadow-lg border-0 bg-gradient-to-br from-background to-muted/20">
                    <CardHeader className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 border-b">
                        ...
                        <CardDescription className="text-base">
                            Define a new maintenance type for your fleet management system
                        </CardDescription>
                    </CardHeader>
                            ...
                            <div className="space-y-4">
                                <div className="rounded-lg bg-slate-50 dark:bg-slate-800/50 p-4 border border-slate-200 dark:border-slate-700">
                                    ...
                                    <Input
                                        ...
                                        className={`transition-colors focus:ring-2 focus:ring-blue-500 ${allErrors.name ? 'border-red-500 focus:ring-red-500' : ''}`}
                                    />
                                    {allErrors.name && (
                            ...
                            <div className="space-y-4">
                                <div className="rounded-lg bg-slate-50 dark:bg-slate-800/50 p-4 border border-slate-200 dark:border-slate-700">
                                    ...
                                    <Select value={data.category} onValueChange={(value) => handleFieldChange('category', value)}>
                                        <SelectTrigger className={`transition-colors focus:ring-2 focus:ring-blue-500 ${allErrors.category ? 'border-red-500 focus:ring-red-500' : ''}`}>
                                ...
                                <div className="space-y-4">
                                    <div className="rounded-lg bg-slate-50 dark:bg-slate-800/50 p-4 border border-slate-200 dark:border-slate-700">
                                        ...
                                        <Input
                                            ...
                                            min="1"
                                            className={`transition-colors focus:ring-2 focus:ring-blue-500 ${allErrors.interval_km ? 'border-red-500 focus:ring-red-500' : ''}`}
                                        />
                                ...
                                <div className="space-y-4">
                                    <div className="rounded-lg bg-slate-50 dark:bg-slate-800/50 p-4 border border-slate-200 dark:border-slate-700">
                                        ...
                                        <Input
                                            ...
                                            placeholder="e.g., 6"
                                            min="1"
                                            className={`transition-colors focus:ring-2 focus:ring-blue-500 ${allErrors.interval_months ? 'border-red-500 focus:ring-red-500' : ''}`}
                                        />
                            ...
                            <div className="space-y-4">
                                <div className="rounded-lg bg-slate-50 dark:bg-slate-800/50 p-4 border border-slate-200 dark:border-slate-700">
                                    ...
                                    <Input
                                        ...
                                        min="0"
                                        step="0.01"
                                        className={`transition-colors focus:ring-2 focus:ring-blue-500 ${allErrors.estimated_cost ? 'border-red-500 focus:ring-red-500' : ''}`}
                                    />
                            ...
                            <div className="space-y-4">
                                <div className="rounded-lg bg-slate-50 dark:bg-slate-800/50 p-4 border border-slate-200 dark:border-slate-700">
                                    ...
                                    <Textarea
                                        ...
                                        rows={4}
                                        className={`transition-colors focus:ring-2 focus:ring-blue-500 ${allErrors.description ? 'border-red-500 focus:ring-red-500' : ''}`}
                                    />
                            ...
                            <div className="flex items-center justify-between pt-6 border-t border-slate-200 dark:border-slate-700">
                                ...
                                <div className="flex gap-3">
                                    ...
                                    >
                                        ...
                                        {processing ? 'Creating...' : 'Create Maintenance Type'}
                                    </Button>
                                </div>
                            </div>
                        </form>

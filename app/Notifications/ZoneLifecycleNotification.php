...
class ZoneLifecycleNotification extends Notification implements ChannelAwareNotification, ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $regionName = $this->payload['region']['name'] ?? null;

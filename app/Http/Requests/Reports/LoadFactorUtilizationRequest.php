...
class LoadFactorUtilizationRequest extends FormRequest
{
    /**
    ...
    public function authorize(): bool
    {
        ...
        return $user->can('reports.load-factor-utilization.view') || $user->can('reports.load-factor-utilization.export');
    }

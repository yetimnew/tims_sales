...
class UpdateOperationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $operationId = $operation instanceof Operation ? $operation->getKey() : $operation;

        return [
            'operationid' => ['required', 'string', 'max:255', Rule::unique('operations', 'operationid')->ignore($operationId)],

...
class StatusIndexFilters
{
    ...
    public static function fromRequest(
        ...
        $statusTypeCandidate = $request->input('statustype_id');
        $statusTypeId = null;

        if ($statusTypeCandidate !== null && $statusTypeCandidate !== '') {
            $statusTypeId = is_numeric($statusTypeCandidate) ? (int) $statusTypeCandidate : null;
        ...
        return new self($search, $statusTypeId, $sort, $direction, $perPage);
    }
    ...
    public function toFilterArray(): array
    {
        return [
            'search' => $this->search,
            'statustype_id' => $this->statusTypeId,
            'sort' => $this->sort,
